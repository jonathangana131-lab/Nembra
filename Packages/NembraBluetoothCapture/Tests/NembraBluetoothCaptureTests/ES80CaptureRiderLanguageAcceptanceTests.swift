...
struct ES80CaptureRiderLanguageAcceptanceTests {
    ...
    func primaryStatesStayHumanFirst() throws {
        ...
        for phrase in banned {
            #expect(!riderSurface.contains(phrase), "Primary Capture copy still exposes engineering vocabulary: \(phrase)")
        }
    ...
    @Test("engineering truth remains available in Details")
    ...
    @Test("language cleanup preserves physical lock, evidence integrity, and stable actions")
