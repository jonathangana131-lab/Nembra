...
struct PassiveBluetoothExperimentOnePublicAuthoritySurfaceTests {
    ...
    func authoritySurfaceIsSealed() throws {
        ...
        #expect(compactRun.contains("fileprivateinit(admissionIdentity:UUID,peripheralIdentifier:UUID,issuedAtUptimeNanoseconds:UInt64)"))
    ...
    func controllerAdmissionIsProducerDerivedAndOneShot() throws {
        ...
        #expect(compact.contains("funcpreviewForControllerStaging()throws->StagingPreview"))
    }
}
