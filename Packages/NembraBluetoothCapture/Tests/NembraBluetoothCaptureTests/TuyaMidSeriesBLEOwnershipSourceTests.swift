...
struct TuyaMidSeriesBLEOwnershipSourceTests {
    ...
    @Test("new fence composes with process-lifetime retirement")
    func processLifetimeFenceRemainsPresent() throws {
        let source = try read("NembraApp/App/NembraCaptureEntrypoint.swift")
        ...
        #expect(source.contains("process_tuya_ble_ownership_blocks_scan"))
    }
