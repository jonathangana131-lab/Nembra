...
struct TuyaSecureLinkProductSurfaceSourceTests {
    ...
    func acceptedExperienceIsCaptureCompleteShareFlow() throws {
        ...
        #expect(body.contains("test.acceptedArtifactIntegrityVerified"))
        #expect(body.contains("Integrity verified"))
        #expect(body.contains("The same verified bytes remain sealed."))
