...
struct TuyaPhysicalAppContainerTransportProbeSourceTests {
    ...
    func probeRequiresRoundTripAndFailsClosedOnAuthority() throws {
        ...
        #expect(probe.contains("probe_created_capture_authority=false"))
        #expect(probe.contains("probe_created_physical_authority=false"))
        #expect(probe.contains("probe_created_protocol_semantics=false"))
        ...
        #expect(probe.contains("pre-existing app or field authority"))
        #expect(probe.contains("pre-existing protocol knowledge"))
