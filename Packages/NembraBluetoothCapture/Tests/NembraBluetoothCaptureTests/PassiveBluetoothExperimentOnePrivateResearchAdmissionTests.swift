...
struct PassiveBluetoothExperimentOnePrivateResearchAdmissionTests {
    ...
    @Test("retired TODAY wrapper and producer cannot mint current research capability")
    func retiredTodaySignedFieldPathFailsClosed() throws {
        ...
        #expect(
            producer.contains(
                "Use scripts/field/install_one_time_capture.command for ES80-AUTHENTICATED-STATIONARY-v1 after exact current-product acceptance."
            )
        )
