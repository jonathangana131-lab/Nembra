...
/// Expected-red provenance contract for the current flagship Experiment One handoff.
///
/// This is software monotonic callback chronology only. It does not claim BLE/RF
/// emission time, physical AOVOPRO ES80 identity, protocol semantics, telemetry
/// truth, or command acknowledgement.
struct ForegroundCoreBluetoothCaptureControllerExperimentOnePostAdmissionRediscoveryCurrentHeadTests {
    ...
    @Test("controller requires post-admission rediscovery before selecting target or installing recorder")
    func currentCatalogMustContainPostAdmissionEvidence() throws {
