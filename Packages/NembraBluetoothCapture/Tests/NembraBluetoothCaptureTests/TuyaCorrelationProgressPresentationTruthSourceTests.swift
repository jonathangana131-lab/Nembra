...
struct TuyaCorrelationProgressPresentationTruthSourceTests {
    ...
    func completedCorrelationDoesNotFallBackToOneOfFour() throws {
        ...
        // The package/controller intentionally releases the live correlation session before
        // publishing `.correlated`; completed presentation must not fall back to a nil session.
    ...
    @Test("in-progress correlation ordinal remains package-progress-derived")
