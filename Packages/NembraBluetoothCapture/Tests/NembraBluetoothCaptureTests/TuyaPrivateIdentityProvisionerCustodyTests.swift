...
struct TuyaPrivateIdentityProvisionerCustodyTests {
    ...
    func descriptorBoundPublicationSourceContract() throws {
        ...
        #expect(shell.contains("AUTHORITY_HELPER_SHA256=\"5ffb2118f6ecb260dce35d9663c0e0840ca72590e8b1ef4ab00b75fe2f97f646\""))
        ...
        #expect(writer.contains("_sanitize_held_private_descriptor"))
