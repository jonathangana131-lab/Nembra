...
struct TuyaApplicationAccountUIDExportCustodySourceTests {
    ...
    @Test("account UID custody covers malformed UID-bearing keys without blanket uid classification")
    func accountUIDCustodyIsExactValueBound() throws {
        ...
        #expect(helper.contains("originalKey.replacingOccurrences"))
        #expect(helper.contains("originalValue.replacingOccurrences"))
        #expect(helper.contains("accountUID"))
