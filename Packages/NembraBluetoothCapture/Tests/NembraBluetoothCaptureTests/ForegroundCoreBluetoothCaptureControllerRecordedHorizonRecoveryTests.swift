...
struct ForegroundCoreBluetoothCaptureControllerRecordedHorizonRecoveryTests {
    ...
    func recordedHorizonCommitFailureUsesProducerQuarantine() throws {
        ...
        let mutation = try #require(section.range(of: "recordBoundaryWithMutationOutcome")?.lowerBound)
        ...
        #expect(section.distance(from: section.startIndex, to: mutation) < section.distance(from: section.startIndex, to: recordedCase))
