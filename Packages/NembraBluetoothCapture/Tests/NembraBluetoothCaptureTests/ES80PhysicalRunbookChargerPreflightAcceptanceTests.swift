...
struct ES80PhysicalRunbookChargerPreflightAcceptanceTests {
    ...
    func runbookPinsChargerDeclarationWithoutPromotingItToMeasuredTruth() throws {
        ...
        // explicitly blocked, Disconnected is required before OFF 1, and the UI states that
        // Nembra cannot sense the charger directly. The field procedure must not be weaker.
