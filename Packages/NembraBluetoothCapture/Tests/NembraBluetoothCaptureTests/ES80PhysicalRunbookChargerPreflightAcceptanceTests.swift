...
struct ES80PhysicalRunbookChargerPreflightAcceptanceTests {
    ...
    func runbookPinsChargerDeclarationWithoutPromotingItToMeasuredTruth() throws {
        ...
        // explicitly blocked, Disconnected is required before the field capture can continue, and
        // the UI states that Nembra cannot sense the charger directly. The field procedure must
        // not be weaker.
