...
struct TuyaCaptureRootProductSurfaceSourceTests {
    @Test("public launch is guided and cannot bootstrap account or Bluetooth authority without complete field metadata")
    func publicRootIsGuidedPreflight() throws {
        ...
        #expect(root.contains("prepareAuthorizationTransport()"))
