...
struct TuyaAuthenticationPromotionReentrancySourceTests {
    ...
    func authenticatedPromotionRevalidatesAuthorityAfterActorHops() throws {
        ...
        // Both actor hops above can interleave foreground/view/account retirement. Before
        // resurrecting app presentation as `.observing`, the exact generation, phase, and
        // same-account source lease must still be current.
