...
struct AuthenticatedStationaryCaptureInstallManifestEvidenceMatchingTests {
    ...
    private func manifestData(authorizationEnvelopeSHA256: String) -> Data {
        Data("""
        {
          ...
          "manifestKind": "retained-install-exact-subject-bindings-not-authorization",
          ...
          "signedInstallableSHA256": "7777777777777777777777777777777777777777777777777777777777777777",
