...
struct PassiveBluetoothCaptureFieldAuthorizationTests {
    ...
    @Test
    func validSignedGoBindsExactRecordRunningBuildAndInfoPlist() throws {
        let fixture = try makeFixture()

        let authorization = try PassiveBluetoothCaptureFieldAuthorizationVerifier.verify(
            fixture.envelope,
    ...
    func signatureFromDifferentKeyFailsClosed() throws {
        ...
        #expect(throws: PassiveBluetoothCaptureFieldAuthorizationError.invalidSignature) {
            _ = try PassiveBluetoothCaptureFieldAuthorizationVerifier.verify(
                fixture.envelope,
                publicKeyX963Representation: trustedKey.publicKey.x963Representation,
                runtimeBuildIdentity: fixture.runtimeIdentity,
                runtimeInfoPlistSHA256: sha256Hex(infoPlistData)
            )
        }
    ...
    func signedPayloadCannotBeReboundToDifferentExternalRecordBytes() throws {
        let fixture = try makeFixture()
        var alternateRecordObject = baseRecordObject()
        alternateRecordObject["buildIdentifier"] = "Capture Build V14-fedcba543210"
        let alternateRecord = try json(alternateRecordObject)
        ...
        #expect(
            throws: PassiveBluetoothCaptureFieldAuthorizationError.externalBuildRecordDigestMismatch
        ) {
            _ = try PassiveBluetoothCaptureFieldAuthorizationVerifier.verify(
                reboundEnvelope,
                publicKeyX963Representation: fixture.privateKey.publicKey.x963Representation,
    ...
    func acceptedRecordForDifferentRuntimeInfoPlistFailsClosed() throws {
        ...
        #expect(throws: PassiveBluetoothCaptureFieldAuthorizationError.runtimeInfoPlistMismatch) {
            _ = try PassiveBluetoothCaptureFieldAuthorizationVerifier.verify(
                ...
                publicKeyX963Representation: fixture.privateKey.publicKey.x963Representation,
                runtimeBuildIdentity: fixture.runtimeIdentity,
                runtimeInfoPlistSHA256: sha256Hex(Data("different Info.plist".utf8))
            )
        }
    }
    ...
    func onlyCanonicalSignedGoDecisionIsAccepted() throws {
        ...
        #expect(
            throws: PassiveBluetoothCaptureFieldAuthorizationError.unsupportedDecision("NO_GO")
        ) {
            _ = try PassiveBluetoothCaptureFieldAuthorizationVerifier.verify(
                envelope,
    ...
    func signedMalformedExternalBuildRecordCannotMintAuthority() throws {
        ...
        #expect(
            throws: PassiveBluetoothCaptureFieldAuthorizationError.invalidExternalBuildRecord
        ) {
            _ = try PassiveBluetoothCaptureFieldAuthorizationVerifier.verify(
                envelope,
                publicKeyX963Representation: signingKey.publicKey.x963Representation,
    ...
    func malformedTrustKeyFailsClosedBeforeAuthorityIsMinted() throws {
        ...
        #expect(
            throws: PassiveBluetoothCaptureFieldAuthorizationError.invalidAuthorizationPublicKey
        ) {
            _ = try PassiveBluetoothCaptureFieldAuthorizationVerifier.verify(
                fixture.envelope,
