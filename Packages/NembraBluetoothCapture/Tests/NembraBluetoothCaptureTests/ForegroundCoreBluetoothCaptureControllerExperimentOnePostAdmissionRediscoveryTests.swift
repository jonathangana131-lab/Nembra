...
struct ForegroundCoreBluetoothCaptureControllerExperimentOnePostAdmissionRediscoveryTests {
    ...
    @Test("controller requires rediscovery strictly after admission before recorder installation")
    func currentCatalogMustBePostAdmissionEvidence() throws {
        ...
        let stagingPreview = try #require(body.range(of: "let preview = try admission.previewForControllerStaging()"))
        ...
        #expect(stagingPreview.lowerBound < latestAdvertisement.lowerBound)
