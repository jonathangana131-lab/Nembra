...
struct ForegroundCoreBluetoothCaptureControllerHorizonIntegrationTests {
    ...
    @Test("Horizon admission requires a durably committed Ready under current authority")
    ...
    @Test("Horizon drains exact prefix, records boundary, freezes JSON, then resolves terminal suffix")
