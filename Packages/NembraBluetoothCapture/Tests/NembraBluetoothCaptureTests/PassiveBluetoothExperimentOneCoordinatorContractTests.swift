...
struct PassiveBluetoothExperimentOneCoordinatorContractTests {
    ...
    func connectionDoesNotBurnAdmissionBeforeTargetReappears() throws {
        ...
        let connectability = try #require(connection.range(of: "discovery.isConnectable != false"))
        ...
        #expect(exactLookup.lowerBound < connectability.lowerBound)
        #expect(connectability.lowerBound < connect.lowerBound)
