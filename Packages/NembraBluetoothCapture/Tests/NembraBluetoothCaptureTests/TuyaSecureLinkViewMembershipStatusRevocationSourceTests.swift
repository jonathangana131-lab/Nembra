...
struct TuyaSecureLinkViewMembershipStatusRevocationSourceTests {
    ...
    func exitRevokesMembershipStatusWithProof() throws {
        ...
        try assertMembershipStatusRevoked(in: cleanup)
    }

    @Test("foreground loss cannot retain verified membership copy after revoking the membership proof")
    ...
    private func assertMembershipStatusRevoked(in cleanup: String) throws {
