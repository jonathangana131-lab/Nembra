...
struct TuyaSecureLinkViewMembershipStatusRevocationSourceTests {
    @Test("view exit revokes positive membership copy with the proof")
    func exitRevokesMembershipStatusWithProof() throws {
        ...
        try expectRevocationOrdering(in: cleanup)
    }

    @Test("foreground loss revokes positive membership copy with the proof")
    ...
    private func expectRevocationOrdering(in cleanup: String) throws {
