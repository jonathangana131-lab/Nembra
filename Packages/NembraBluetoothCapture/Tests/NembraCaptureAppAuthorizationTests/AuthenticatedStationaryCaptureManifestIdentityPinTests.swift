...
@Suite("Authenticated stationary Capture manifest identity pin")
@MainActor
struct AuthenticatedStationaryCaptureManifestIdentityPinTests {
    ...
    @Test("same runtime and bindings cannot replace retained IPA after challenge creation")
    ...
    @Test("the exact admitted manifest remains valid at the composition boundary")
    ...
    @Test("production source pins the admitted manifest without widening authority")
    func productionSourcePinsManifestIdentity() throws {
        ...
        #expect(source.contains("-> AuthenticatedStationaryCaptureCapabilityGate"))
