...
struct AuthenticatedStationaryCaptureSignerRendezvousOutboxTests {
    @Test("publishes the exact canonical rendezvous with owner-only file mode")
    ...
    func rejectsSymlinkedHandoffDirectory() throws {
        ...
        do {
            ...
            // Exact errno differs between Darwin builds (ELOOP vs ENOTDIR); success is forbidden.
        }
