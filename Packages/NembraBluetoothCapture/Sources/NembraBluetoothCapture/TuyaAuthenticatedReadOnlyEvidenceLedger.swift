...
public struct TuyaAuthenticatedReadOnlyEvidenceArtifact: Equatable, Sendable {
    ...
    public var latestApplicationPayloadUptimeNanoseconds: UInt64? {
        notifications.last?.monotonicNanoseconds
    }
    ...
    public func encodedJSON() throws -> Data {
        struct Export: Encodable {
            ...
            let notificationCharacteristicUUID: String
        ...
        let export = Export(
            ...
            serviceUUID: TuyaFD50AuthenticatedReadOnlyTarget.serviceUUID,
            notificationCharacteristicUUID: TuyaFD50AuthenticatedReadOnlyTarget.notificationCharacteristicUUID,
...
/// preserve already-authenticated notification evidence in receipt order and seal it exactly once.
public actor TuyaAuthenticatedReadOnlyEvidenceLedger {
    public enum AdmissionError: Error, Equatable, Sendable {
        ...
        case invalidConnectionStartedUptime
        case invalidAuthenticatedUptime
        case authenticationPredatesConnection
    ...
    private let connectionStartedAtUptimeNanoseconds: UInt64
    ...
    public init(
        ...
        guard connectionStartedAtUptimeNanoseconds > 0 else { throw AdmissionError.invalidConnectionStartedUptime }
        guard authenticatedAtUptimeNanoseconds > 0 else { throw AdmissionError.invalidAuthenticatedUptime }
        guard authenticatedAtUptimeNanoseconds >= connectionStartedAtUptimeNanoseconds else {
            throw AdmissionError.authenticationPredatesConnection
        }
        self.connectionGeneration = connectionGeneration
        self.connectionStartedAtUptimeNanoseconds = connectionStartedAtUptimeNanoseconds
        self.authenticatedAtUptimeNanoseconds = authenticatedAtUptimeNanoseconds
    ...
    public func currentPreflightSnapshot() -> TuyaAuthenticatedReadOnlyPreflightSnapshot {
        TuyaAuthenticatedReadOnlyPreflightSnapshot(
            ...
            latestObservedUptimeNanoseconds: latestObservedUptimeNanoseconds,
            applicationPayloadCount: notifications.count,
            latestApplicationPayloadUptimeNanoseconds: notifications.last?.monotonicNanoseconds,
            connectionGeneration: connectionGeneration
        )
    }
