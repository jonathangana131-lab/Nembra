...
final class PassiveBluetoothExperimentOneCaptureAdmission {
    ...
    /// Read-only package staging information for recoverable pre-consumption checks.
    ///
    ...
    /// Exposes only enough sealed producer state to perform recoverable controller staging before
