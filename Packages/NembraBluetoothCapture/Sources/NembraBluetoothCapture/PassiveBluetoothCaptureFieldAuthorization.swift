...
/// Nembra's independent package-pinned authority, the exact signed-installable evidence, and the
/// build identity measured from the running application.
///
...
public enum PassiveBluetoothCaptureFieldAuthorizationError: Error, Equatable, Sendable {
    ...
    case signedFieldArtifactEvidenceMismatch
...
/// installable, its schema-v2 field evidence, and schema-v3 external build record are independently
/// accepted. The signed payload binds the exact bytes of both external evidence records.
public enum PassiveBluetoothCaptureFieldAuthorizationVerifier {
    ...
    package static func verify(
        ...
        do {
            ...
            throw PassiveBluetoothCaptureFieldAuthorizationError.signedFieldArtifactEvidenceMismatch
        }
