...
struct PassiveCoreBluetoothObservationBoundaryQueueGate: Equatable, Sendable {
    ...
    /// reopen by itself. The gate remains terminal until a separately accepted routing,
    ...
    /// retirement proof, exact queue-tail stability, and zero unrouted retained
    /// evidence before terminal can reopen.
    @discardableResult
