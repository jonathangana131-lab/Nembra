...
struct BatteryEvidenceObservationCodableValidationTests {
    ...
    func decodedNonFiniteTimestampIsRejected() {
        let payload = Data(
            #"{"value":{"field":"stateOfChargePercent","numericValue":50},"role":"verifiedVehicleMeasurement","receivedAtUptimeNanoseconds":1,"receivedAtDate":"Infinity","continuity":"continuous"}"#.utf8
        )
