...
struct AdaptiveBatteryRangeWindowAssemblerPolicyTransitionTests {
    ...
    private func policy(minimumConsumedPercentagePoints: Double) throws -> AdaptiveBatteryRangePolicy {
    ...
    @Test("loosening the live threshold can close a retained flat-SoC span")
    func loosenedPolicyClosesRetainedSpan() throws {
