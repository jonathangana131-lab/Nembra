...
final class ES80ResearchCaptureUITests: XCTestCase {
    ...
    func testV14SimulatorQAHorizonReadyRemainsActionableAtAccessibilityExtraExtraExtraLarge() {
        ...
        bringIntoScreenshotViewport(
            progress,
            in: app,
            context: "Capture progress at Horizon Ready Accessibility XXXL"
        )
        assertVisibleInScreenshotViewport(
            progress,
            windowFrame: app.windows.firstMatch.frame,
        ...
        bringIntoScreenshotViewport(
            health,
            in: app,
            context: "Capture health at Horizon Ready Accessibility XXXL"
        )
        assertVisibleInScreenshotViewport(
            health,
            windowFrame: app.windows.firstMatch.frame,
        ...
        bringIntoScreenshotViewport(
            readyState,
            in: app,
            context: "Horizon-ready status at Accessibility XXXL"
        )
        assertVisibleInScreenshotViewport(
            readyState,
            windowFrame: app.windows.firstMatch.frame,
        ...
        bringIntoScreenshotViewport(
            finish,
            in: app,
            context: "Seal Capture action at Horizon Ready Accessibility XXXL"
        )
        assertVisibleInScreenshotViewport(
            finish,
            windowFrame: app.windows.firstMatch.frame,
