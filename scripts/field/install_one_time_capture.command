...
SIGNED_APP_CUSTODY_HELPER_RELATIVE="scripts/ci/capture_signed_app_install_custody.py"
...
HELPER_ACCEPTED_BLOB="$(GIT_NO_REPLACE_OBJECTS=1 git rev-parse "HEAD:$SIGNED_APP_CUSTODY_HELPER_RELATIVE" 2>/dev/null || true)"
HELPER_ACTUAL_BLOB="$(GIT_NO_REPLACE_OBJECTS=1 git hash-object --no-filters -- "$SIGNED_APP_CUSTODY_HELPER_RELATIVE" 2>/dev/null || true)"
