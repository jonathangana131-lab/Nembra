...
[[ -n "$BUILT_APP_ID_PREFIX" && "$BUILT_APP_ID_PREFIX" != "*" && "$BUILT_APP_ID_PREFIX" != "$BUILT_APPLICATION_IDENTIFIER" ]] || \
    die "Final signed Capture app application-identifier has no acceptable concrete App ID prefix. Discard this candidate."
...
PROFILE_IDENTITY_REMAINDER="${PROFILE_SIGNING_IDENTITY#*$'\t'}"
PROFILE_TEAM_IDENTIFIER="${PROFILE_IDENTITY_REMAINDER%%$'\t'*}"
PROFILE_ROOT_TEAM_IDENTIFIER="${PROFILE_IDENTITY_REMAINDER#*$'\t'}"
...
unset SIGNED_ENTITLEMENTS_OUTPUT BUILT_SIGNING_IDENTITY BUILT_APPLICATION_IDENTIFIER BUILT_TEAM_IDENTIFIER BUILT_APP_ID_PREFIX PROFILE_PLIST_XML PROFILE_SIGNING_IDENTITY PROFILE_APPLICATION_IDENTIFIER PROFILE_IDENTITY_REMAINDER PROFILE_TEAM_IDENTIFIER PROFILE_ROOT_TEAM_IDENTIFIER BUILT_PROFILE
