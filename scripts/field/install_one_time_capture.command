...
printf '%s\n' \
    ...
    "Only after all app gates are green: complete the package-owned OFF1→ON1→OFF2→ON2 correlation exactly as Capture prompts, then tap Confirm correlated Bluetooth target before Start secure read-only test." \
