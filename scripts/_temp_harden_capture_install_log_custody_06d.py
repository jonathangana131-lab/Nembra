...
struct TuyaFieldInstallerPrivateInstallLogCustodySourceTests {
    ...
    @Test("strong intended-device, V14 baseline, and built-app provenance custody remain intact")
    func hardeningDoesNotRegressCurrentFieldAuthority() throws {
        ...
        #expect(installer.contains("BUILT_BUILD_IDENTIFIER"))
        #expect(installer.contains("BUILT_SOURCE_SHA"))
        #expect(installer.contains("BUILT_BUNDLE_ID"))
