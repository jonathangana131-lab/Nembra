...
EXPECTED_PRODUCT_PARENT = "522716b8112fda6456beba24a62a6a563e66629a"
...
# Preserve the already-landed correlation presentation repair. This child must
# never replay an older Entrypoint over the current product bytes.
for needle in (
    ...
    if needle not in source:
        raise SystemExit(f"Current product correlation truth missing before account repair: {needle}")
...
# Account switching is setup recovery only. It must never create target,
# Bluetooth, package-authentication, telemetry, or command authority.
