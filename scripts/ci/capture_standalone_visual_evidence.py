...
def main() -> int:
    ...
    try:
        ...
        # The shipping Capture root currently forces preferredColorScheme(.dark). This probe changes
        # the *system* appearance only and must not be labeled as app light-mode evidence.
