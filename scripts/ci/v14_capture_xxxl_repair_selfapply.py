...
shell_source = Path(shell).read_text()
...
combined = shell_source + app_source
missing = [item for item in required if item not in combined]
if missing:
    raise SystemExit("missing repaired contract: " + repr(missing))
if ".dynamicTypeSize(" in shell_source or ".dynamicTypeSize(" in app_source:
