#!/usr/bin/env python3
"""Portable acceptance for the opaque private-input review commitment."""
...
def load_guard():
    name = "capture_private_review_commitment_guard_test"
...
class PrivateReviewCommitmentTests(unittest.TestCase):
    ...
    def snapshot_generation_b_and_replace_key(self) -> str:
        ...
        replacement = subprocess.run(
            [
                "/usr/bin/python3", "-I", str(COMMITMENT), "create",
    ...
    def test_coherent_private_generation_witness_and_key_replacement_cannot_self_authorize(self) -> None:
        ...
        replacement_tag = self.snapshot_generation_b_and_replace_key()
        ...
        self.assertEqual(
            ...
            ["pod"],
            "replaced private generation reached a second CocoaPods invocation",
        )
