#!/usr/bin/env python3
"""Expected-red source contract for selected Xcode developer-tree custody.
...
class CaptureFieldSelectedXcodeCustodyTests(unittest.TestCase):
    ...
    def test_caller_fence_alone_is_not_misrepresented_as_selected_toolchain_custody(self) -> None:
        # #2915 owns the caller DEVELOPER_DIR fence. This test intentionally
        # requires the additional selected-subject proof so that a future
        # repair cannot make this lane green by only adding `unset DEVELOPER_DIR`.
