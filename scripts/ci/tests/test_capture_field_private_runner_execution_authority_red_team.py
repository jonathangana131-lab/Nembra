#!/usr/bin/env python3
"""Expected-red/green V14 witness for mutable private-runner execution after source preflight."""
...
class CaptureFieldPrivateRunnerExecutionAuthorityRedTeamTests(unittest.TestCase):
    def test_same_path_replacement_after_preflight_executes_replacement_bytes(self) -> None:
        """Model the exact primitive used by a direct mutable-path import."""
