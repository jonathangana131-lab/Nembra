#!/usr/bin/env python3
"""Behavioral acceptance for canonical Final-GO signed-candidate composition."""
...
class FreshSignedCandidateCompositionTests(unittest.TestCase):
    ...
    def test_malformed_retained_ipa_cannot_return_go_without_fresh_reinspection(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            if "intended_device_udid_file" in inspect.signature(hardened.build_final_go_record).parameters:
            ...
            foundation_record = {
                ...
                "independentRetainedCandidateCrosscheck": {
                    key: value for key, value in crosscheck_execution.items() if key != "executionCustody"
                },
