...
This file is exploit evidence only. Success means the reviewed product parent can
still admit SDK-A + Runtime-B when TuyaRuntime is replaced after cached-parent
validation but before the final child stat/open/stat.
"""
