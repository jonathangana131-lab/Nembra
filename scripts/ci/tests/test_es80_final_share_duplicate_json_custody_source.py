#!/usr/bin/env python3
"""Source contract for exact-byte final Share JSON custody.
...
keys before JSONSerialization/JSONDecoder can choose parser precedence. This regression remains
source-level as a cheap custody pin alongside executable package coverage.
"""
