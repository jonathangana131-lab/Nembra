...
keys before JSONSerialization/JSONDecoder can choose parser precedence. This regression stays
source-level as a portable guard alongside executable package tests.
"""
