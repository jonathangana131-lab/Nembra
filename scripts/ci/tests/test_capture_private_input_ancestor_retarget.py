...
SPEC = importlib.util.spec_from_file_location("nembra_private_input_guard_convergence", GUARD)
...
class PrivateInputAncestorRetargetTests(unittest.TestCase):
    def test_parser_rejects_checkout_visible_private_sdk_symlink_before_child(self) -> None:
