...
VALIDATION ONLY. The merged Final-GO verifier currently treats an exact-shape operator JSON file
as sufficient evidence for installation/runtime/preflight observations. V14 requires those claims
to remain fail-closed unless the Final-GO path can bind them to a trusted operator/device evidence
