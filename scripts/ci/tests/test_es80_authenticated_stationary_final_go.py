...
class F:
 ...
 def inst(self,repo,s,dev,h,lock,cocoa):
  assert h==H(b'device-token');assert lock=='a'*64;assert cocoa=='e'*64
...
class T(unittest.TestCase):
 ...
 def test_candidate_review_requires_canonical_build_subject_digests(self):
