...
TEMP = {
    Path(".github/workflows/tmp-capture-ax-copy-truth.yml"),
    Path(".github/workflows/tmp-capture-ax-copy-truth-launch.yml"),
    Path("scripts/ci/tmp_capture_ax_copy_truth.py"),
    Path("scripts/ci/tmp_capture_ax_copy_truth_v2.py"),
}
...
allowed = {str(path) for path in TEMP}
