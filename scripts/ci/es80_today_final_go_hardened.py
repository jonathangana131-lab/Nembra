...
def _fresh_signed_candidate_subject(
    *,
    ...
    """Derive the candidate subject only from fresh reviewed Apple inspection output."""
    try:
...
def build_final_go_record(
    *,
    ...
    """Run the foundation only after fresh signed-candidate and default-branch Xcode authority."""
