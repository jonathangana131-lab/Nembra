...
if [[ ! "$EXPECTED_SOURCE_SHA" =~ ^[0-9a-f]{40}$ ]]; then
  echo "EXPECTED_SOURCE_SHA must be the exact lowercase 40-hex checked-out source head." >&2
  exit 6
fi
...
sleep 1
AX5_SCREENSHOT="$ARTIFACTS_DIR/screenshots/standalone-unprovisioned-dark-ax5.png"
...
record = {
    ...
    "screenshots": [
        ...
        },
        {
            ...
            "relativePath": "screenshots/standalone-unprovisioned-dark-ax5.png",
