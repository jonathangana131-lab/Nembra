...
# simctl launch forwards host variables prefixed with SIMCTL_CHILD_ into the app. Refuse inherited
# synthetic-authority fixtures instead of merely promising that this script does not set one.
