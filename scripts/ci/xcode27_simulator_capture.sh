...
# Dashboard accessibility stress uses the real iOS Simulator system preference,
# not a SwiftUI test override. AX5 is the maximum accessibility category and is
# intentionally captured for both stopped controls and the moving cockpit.
...
# Leave subsequent cleanup/diagnostics in the normal baseline environment.
