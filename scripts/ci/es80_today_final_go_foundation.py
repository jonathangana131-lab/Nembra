...
# Preserve existing constants and validation helpers for compatibility. The authority-bearing
...
# remains the closed-world validator consumed only by the hardened composer.
