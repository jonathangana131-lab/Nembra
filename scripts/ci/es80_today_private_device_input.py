...
def _refuse_existing_target_before_secret(directory_descriptor: int, filename: str) -> None:
    ...
    This is a secret-minimization precheck only. The later O_EXCL create remains the race authority
    because a target may appear after this check and before the exclusive descriptor-relative open.
    """
    try:
