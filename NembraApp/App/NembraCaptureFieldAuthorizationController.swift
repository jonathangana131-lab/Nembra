...
final class NembraCaptureFieldAuthorizationController {
    ...
    init() {
        ...
        do {
            // The external appDataContainer transport cannot place the very first retained manifest
            // into a directory that does not yet exist. Prepare only that owner-controlled directory
            // at app-controller construction time; this creates no subject, challenge or authority.
            ...
            // fall back to an unverified filesystem path or let OFF1 proceed around transport custody.
