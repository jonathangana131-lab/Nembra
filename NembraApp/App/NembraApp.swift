...
private struct ES80ExperimentOneFieldNoGoView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(
                ...
                VStack(
                    ...
                    HStack(spacing: isAccessibilityLayout ? 0 : 12) {
                        ...
                        VStack(alignment: .leading, spacing: isAccessibilityLayout ? 2 : 4) {
                            Text("NEMBRA CAPTURE")
                                .font((isAccessibilityLayout ? Font.caption2 : Font.caption).monospaced().weight(.bold))
                    ...
                    .accessibilityHint("Final exact-build checks are still in progress.")
                ...
                if isAccessibilityLayout {
                    VStack(alignment: .leading, spacing: 3) {
                        ...
                        Text("NO-GO")
                            ...
                            .foregroundStyle(.orange)
                        Text("Exact-build checks must pass before Bluetooth capture can begin.")
                ...
                VStack(alignment: .leading, spacing: isAccessibilityLayout ? 8 : 14) {
                    Button {
                ...
                .background(.white.opacity(0.045), in: RoundedRectangle(cornerRadius: isAccessibilityLayout ? 16 : 20, style: .continuous))
            ...
            .padding(.bottom, verticalSizeClass == .compact ? 20 : (isAccessibilityLayout ? 24 : 42))
            .frame(maxWidth: .infinity)
        }
