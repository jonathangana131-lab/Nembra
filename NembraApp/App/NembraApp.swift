...
private struct ES80ExperimentOneFieldNoGoView: View {
    ...
    private var physicalLockAccessibilityLabel: String {
        "Physical Experiment One is locked. This build cannot start the scooter procedure. Nembra will enable it only after this exact build passes final validation and is deliberately authorized."
    }
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 28) {
                VStack(alignment: .leading, spacing: 14) {
                    ...
                    Text("This build is not cleared to begin a physical ES80 capture yet.")
                ...
                HStack(alignment: .top, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        Text("The OFF/ON steps stay hidden until this exact build passes final validation and is deliberately authorized for the field procedure.")
                            .font(.subheadline)
                            .foregroundStyle(.secondary)
                            .fixedSize(horizontal: false, vertical: true)
                    }
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    HStack(spacing: 10) {
                        Image(systemName: "lock.fill")
                            .foregroundStyle(.orange)
                            .accessibilityHidden(true)
                        Text("Field procedure locked on this build")
                ...
                Text("No action is needed on the scooter. Use only a build that explicitly shows GO before starting Experiment One; this screen cannot unlock the procedure.")
                    .font(.footnote)
                    .foregroundStyle(.secondary)
                    .fixedSize(horizontal: false, vertical: true)
            }
