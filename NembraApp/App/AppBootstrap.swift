...
final class AppRuntime {
    ...
    func start() async {
        ...
        // Transport remains connected; only source speed continuity is broken.
        // This gives the app a real `.retained` field state without weakening the
        // consumer rule that all non-connected speed authority is unavailable.
