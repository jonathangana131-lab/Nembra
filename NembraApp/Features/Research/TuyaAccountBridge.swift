...
final class TuyaAccountBridge: ObservableObject {
    ...
    @Published private(set) var selectedDeviceStatusEndpointResult: Any?
    ...
    func prepareRedactedExport() {
        ...
        var envelope: [String: Any] = [
            ...
            "statusEndpointResult": Self.redactSecrets(selectedDeviceStatusEndpointResult ?? NSNull()),
            "safety": [
    ...
    private func clearSelectedDeviceDetails() {
        ...
        selectedDeviceStatusEndpointResult = nil
        redactedExportData = nil
    }
