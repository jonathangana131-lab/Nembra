...
def _authority_bound_initial_snapshot(
    ...
    *,
    ...
    Do not verify authority and then take a second, attacker-selectable baseline.
    Bracket both authority checks with the complete private+generated generation
    snapshot. The exact stable post-check generation becomes the vnode baseline.
    """
