...
# Keep the ordinary restart evidence-neutral; only the impossible active-generation branch retires
# already-existing package ownership.
...
if "failLocally(\n                \"A prior authenticated generation" in section:
    raise SystemExit("old local-failure custody path remains")
