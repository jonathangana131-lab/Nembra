...
3. keep the phone unlocked, screen on, and Nembra foreground for the finite capture window; record `foregroundUnlockedScreenOn` as declared execution context;
