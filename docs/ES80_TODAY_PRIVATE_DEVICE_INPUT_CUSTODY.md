...
`scripts/ci/es80_today_private_device_input.py` removes that write-time pathname authority and closes the accepted failure-cleanup paths:
...
- converts `getpass.GetPassWarning` into a secret-free `secure-terminal-input-unavailable` failure instead of accepting the potentially echoed fallback;
...
- helper source commit: `4a2aa4c3e44bf6127ac841471d356044f0cfce8d`;
- helper path: `scripts/ci/es80_today_private_device_input.py`;
- helper Git blob: `c87dca57361d53ab58b7c2565b414b2c469b58f2`.
...
PRIVATE_INPUT_HELPER_COMMIT='4a2aa4c3e44bf6127ac841471d356044f0cfce8d'
PRIVATE_INPUT_HELPER_BLOB='c87dca57361d53ab58b7c2565b414b2c469b58f2'
...
10. `getpass` echo-fallback warning is rejected before fallback input is consumed;
11. surrounding whitespace/newline is rejected and no final file is created.

The exact accepted helper blob is `c87dca57361d53ab58b7c2565b414b2c469b58f2`; the exact accepted regression blob on `4a2aa4c3e44bf6127ac841471d356044f0cfce8d` is `fead4697f1de4d82d5eb6a095c4367a249279b79`.
