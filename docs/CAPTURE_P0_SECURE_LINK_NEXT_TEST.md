...
- The first run repeatedly disconnected around 30 seconds while the required Tuya application session had not been established; the artifact does not prove the disconnect cause.
