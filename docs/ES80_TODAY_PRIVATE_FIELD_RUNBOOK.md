...
3. The canonical `scripts/ci/xcode27_signed_field_candidate.sh` producer creates one signed/exported physical-iOS Release IPA from that exact frozen source SHA.
