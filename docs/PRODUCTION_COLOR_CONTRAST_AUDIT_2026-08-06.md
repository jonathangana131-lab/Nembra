...
This audit uses current `main@909b0c6f74af9744f33558d88185f3917e900c54` and specifically reviews:
...
`RideRouteMapView` currently renders recorded route polylines using `.primary` at 4 pt over the native MapKit map. Unlike a flat system background, the map contains roads, labels, land, water, imagery-like styling, and light/dark variations chosen by the platform.
